...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `/* common style */
li {
...
.todo-title.active::before {
    content: '🔽';
}
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA,iBAAiB;AACjB;IACI,qBAAqB;AACzB;AACA,gBAAgB;AAChB;IACI,aAAa;IACb,8BAA8B;IAC9B,4BAA4B;AAChC;AACA;IACI,mBAAmB;AACvB;AACA;IACI,mBAAmB;AACvB;AACA;IACI,oBAAoB;AACxB;;AAEA,4BAA4B;AAC5B;IACI,aAAa;AACjB;AACA;IACI,aAAa;AACjB;AACA;IACI,aAAa;AACjB","sourcesContent":["/* common style */\nli {\n    list-style-type: none;\n}\n/* main layout */\nbody {\n    display: grid;\n    grid-template-columns: 1fr 3fr;\n    grid-template-rows: 1fr 10fr;\n}\nh1 {\n    grid-area: 1/1/2/-1;\n}\n#nav {\n    grid-area: 2/1/-1/2;\n}\n#content {\n    grid-area: 2/2/-1/-1;\n}\n\n/* todo-title button style */\n.todo-title::before {\n    content: '▶️';\n}\n.disappear {\n    display: none;\n}\n.todo-title.active::before {\n    content: '🔽';\n}\n"],"sourceRoot":""}]);
// Exports
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   displayAccount: () => (/* binding */ displayAccount)
/* harmony export */ });
...
function formatDate(string) {
    let duedate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(string, 'yyyy-MM-dd', new Date())
    return (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(duedate, "EEEE, MMMM do, yyyy")
}
...
const displayTodo = (todo) => {
    ...
    function addBtnEvent() {
        ...
        addBtn.addEventListener('click', async function(){
            let newItem = (0,_backend__WEBPACK_IMPORTED_MODULE_0__.item)('')
            todo.add(newItem)
    ...
    function addBtnEvent() {
        addBtn.addEventListener('click', async function(){
           ...
           if (data !== '') {
               ...
               let newTodo = (0,_backend__WEBPACK_IMPORTED_MODULE_0__.todo)(...data)
               project.add(newTodo)
...
const displayAccount = (account) => {
    ...
    function addBtnEvent() {
        addBtn.addEventListener('click', async function() {
            let data = await modalController.newModal()
            if(data !== '') {
                let newProject = (0,_backend__WEBPACK_IMPORTED_MODULE_0__.project)(...data)
...
window.addEventListener('load', () => {
    if(localStorage.getItem('account') === null || localStorage.getItem('account') === "undefined") {
        newAccount = (0,_backend__WEBPACK_IMPORTED_MODULE_0__.account)()
    } else {
        // reconstruct objects
        newAccount = (0,_backend__WEBPACK_IMPORTED_MODULE_0__.deserialize)(localStorage.getItem('account'))
        console.log(newAccount)
    }
    (0,_display__WEBPACK_IMPORTED_MODULE_1__.displayAccount)(newAccount).perform()
})
